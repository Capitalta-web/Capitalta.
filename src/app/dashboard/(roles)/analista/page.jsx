...
const MetricCard = ({ title, count, icon, color, loading }) => (
  <MainCard sx={{ height: '100%', display: 'flex', alignItems: 'center', p: 2 }}>
    <Box sx={{ mr: 2, display: 'flex', p: 1.5, borderRadius: '50%', bgcolor: `${color}.light`, color: `${color}.main` }}>
      {icon}
    </Box>
    <Box>
...
export default function AnalistaDashboard() {
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ mb: 4 }}>
        <Typography variant="h4" fontWeight="bold">Dashboard Analista</Typography>
      ...
      <Box sx={{ mb: 2 }}>
        <Typography variant="h5" fontWeight="bold" sx={{ mb: 2 }}>Solicitudes Recientes</Typography>
