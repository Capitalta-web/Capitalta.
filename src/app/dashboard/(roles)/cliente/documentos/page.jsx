...
export default function DocumentosPage() {
  ...
  const getDocStatusIcon = (status) => {
    switch (status) {
      case 'validado': return <CheckCircleIcon color="success" />;
      case 'rechazado': return <ErrorIcon color="error" />;
      case 'subido': return <AccessTimeIcon color="info" />;
  ...
  const getDocStatusLabel = (status) => {
    switch (status) {
      ...
      case 'subido': return 'En Revisión';
