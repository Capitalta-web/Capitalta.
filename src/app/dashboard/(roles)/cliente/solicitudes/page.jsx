        ...
        <Grid container spacing={3}>
          {solicitudes.map((solicitud) => (
            <Grid item xs={12} md={6} lg={4} key={solicitud.id}>
              <Card
                variant="outlined"
                onClick={() => router.push(`/dashboard/cliente/solicitudes/${solicitud.id}`)}
              ...
              >
                <CardContent>
                  ...
                  <Typography variant="caption" display="block" sx={{ mt: 2 }}>
                    Solicitado el: {new Date(solicitud.fecha_solicitud || solicitud.created_at).toLocaleDateString()}
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
