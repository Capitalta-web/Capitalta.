...
export default function Main() {
  ...
  useEffect(() => {
    // Set rate based on credit type
    if (tipoCredito === 'simple') {
      setTasaAnual(24);
    } else if (tipoCredito === 'empresarial') {
      setTasaAnual(24);
    }
  }, [tipoCredito]);
      ...
      <ContainerWrapper>
        <Box sx={{ py: { xs: 6, md: 8 }, textAlign: 'center' }}>
          ...
          <Grid container spacing={{ xs: 3, sm: 4, md: 5 }} justifyContent="center" alignItems="stretch">
            {[
              { src: '/assets/images/capitalta/logo-azul.png', alt: 'Aliado Estratégico' },
              { src: '/assets/images/capitalta/check-logo.png', alt: 'Aliado Estratégico' },
              { src: '/assets/images/capitalta/Yl6dShQz0v_20230403191604.png', alt: 'Aliado Estratégico' },
              { src: '/assets/images/capitalta/cisa.png', alt: 'CISA' }
            ].map((logo, index) => (
              <Grid item xs={12} sm={6} md={3} key={index} sx={{ display: 'flex' }}>
                <Box
                  sx={{
                    ...
                    '&:hover': { transform: 'translateY(-4px)', boxShadow: '0 10px 24px rgba(0,0,0,0.08)', borderColor: 'primary.light' }
                  }}
                >
                  <Box
                    component="img"
