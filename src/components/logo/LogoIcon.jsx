...
export default function LogoIcon() {
  ...
  const shouldUseAsset = Boolean(logoIconPath) && logoIconPath !== logoMainPath;
  ...
  return (
    ...
    >
      {shouldUseAsset ? (
        <CardMedia src={logoIconPath} component="img" alt="logo" sx={{ height: 1, width: 1, objectFit: 'contain' }} loading="lazy" />
      ) : (
