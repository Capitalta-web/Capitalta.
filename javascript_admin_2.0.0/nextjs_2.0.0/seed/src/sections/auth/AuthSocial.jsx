  ...
  return (
    <>
      <Alert sx={{ mb: 2 }} severity="info">
        Social login is view-only. To make it fully functional, please read the documentation provided&nbsp;
        <Link
          component={NextLink}
          underline="hover"
          target="_blank"
          href="https://phoenixcoded.gitbook.io/saasable/admin/development/auth/social-login"
